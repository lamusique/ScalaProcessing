 ...
 */
case class Camera(var eye:ScalaPVector = ScalaPVector.origin, var center:ScalaPVector = ScalaPVector.origin, var up:ScalaPVector = ScalaPVector(0,1,0))(implicit val sp5: ThreeDimensionalPApp) {
  import sp5._
